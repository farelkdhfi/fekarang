...
function SemuaPerwakilanDesa() {
  ...
  const fetchBeritas = async (page) => {
    try {
      const res = await customApi.get(`/perwakilans?page=${page}&limit=4`);
    ...
    <section className="text-sm lg:text-base">
      <div className="py-10 lg:py-20 px-4 sm:px-6 lg:px-20 mt-10">
        <div className="flex justify-center items-center">
          <h1 className="text-xl lg:text-3xl font-bold text-blue-700 font-montserrat mb-10">
...
export default SemuaPerwakilanDesa;
