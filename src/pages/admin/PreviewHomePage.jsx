...
import cibuni1 from '../../assets/cibuni1.jpg';
import cibuni2 from '../../assets/cibuni2.jpg';
import cibuni3 from '../../assets/cibuni3.jpg';
  ...
  return (
    <section>
      <div id='beranda' className=" bg-white">
        <div className="flex flex-col lg:flex-row justify-center items-center gap-5 lg:gap-8 min-h-screen mt-5 px-4">
          {/* Text Section */}
          <motion.div
          ...
          >
            ...
            <motion.h1
              className="text-blue-700 font-bold text-4xl lg:text-6xl"
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            <motion.div
              className="flex flex-col sm:flex-row gap-3 text-sm lg:text-lg mt-5"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            ...
            <motion.h2
              className="text-2xl lg:text-4xl font-bold text-blue-700 mt-4 font-montserrat"
              initial={{ opacity: 0, y: 20 }}
              animate={sectionInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
              transition={{ delay: 0.4, duration: 0.8, ease: "easeOut" }}
            >
            ...
            <React.Fragment key={website._id}>
              ...
              <div className="py-10 lg:py-20 bg-white px-6 lg:px-20">
                <div className="flex flex-col lg:flex-row justify-center items-center lg:gap-9">
                  ...
                  <div className="lg:w-1/2 flex flex-col items-center justify-center lg:flex-none lg:items-start lg:justify-start text-center lg:text-start">
                    <h1 className="lg:text-4xl font-bold text-blue-700 font-montserrat mt-6 text-2xl lg:mt-0">Sambutan Kepala Desa</h1>
                    <p className="text-xl font-bold uppercase">{website.namaKepalaDesa}</p>
                    <p className="text-sm lg:text-base mt-2 font-semibold">Assalamu’alaikum warahmatullahi wabarakatuh,</p>
              ...
              <div className='py-10 lg:py-20 px-6 lg:px-20 text-sm lg:text-base'>
                <div className='flex flex-col justify-center items-center text-center'>
                  <h1 className='lg:text-4xl font-bold text-blue-700 font-montserrat text-2xl'>Struktur Organisasi Desa</h1>
                  <p className='mt-2'>Struktur organisasi dan tata kerja Desa Karanglayung</p>
                </div>
                <div className='grid grid-cols-2 gap-3 lg:gap-0 lg:flex lg:flex-row justify-center items-center mt-10'>
                  <div className='shadow-xl rounded-b-xl flex-col flex justify-center items-center'>
                    <img src={website.fotoKepalaDesa} alt="" className='lg:h-56 lg:w-56 h-24 w-24 rounded-t-xl' />
                    <h3 className='font-semibold mt-2'>Kepala Desa</h3>
                    <h4 className='text-sm text-gray-600 mb-2'>{website.namaKepalaDesa}</h4>
                  </div>
                  <div className='shadow-xl rounded-b-xl flex-col flex justify-center items-center'>
                    <img src={website.fotoSekretarisDesa} alt="" className='lg:h-56 lg:w-56 h-24 w-24 rounded-t-xl' />
                    <h3 className='font-semibold mt-2'>Sekretaris Desa</h3>
                    <h4 className='text-sm text-gray-600 mb-2'>{website.namaSekretarisDesa}</h4>
                  </div>
                  <div className='shadow-xl rounded-b-xl flex-col flex justify-center items-center'>
                    <img src={website.fotoKasiPemerintahan} alt="" className='lg:h-56 lg:w-56 h-24 w-24 rounded-t-xl' />
                  ...
                  <div className='shadow-xl rounded-b-xl flex-col flex justify-center items-center'>
                    <img src={website.fotoKasiKesra} alt="" className='lg:h-56 lg:w-56 h-24 w-24 rounded-t-xl' />
        ...
        <div id='tentang' className="py-10 lg:py-20">
          <h2 className="text-center text-3xl lg:text-4xl font-bold text-blue-700 mb-10">Sejarah Singkat Desa</h2>
          ...
          <p className="mt-6 px-6 lg:px-20 text-sm text-gray-700">
            Desa Karanglayung terletak di sebelah Timur Ibu Kota Kabupaten Tasikmalaya, dengan jarak Ibu Kota Kabupaten Tasikmalaya 36 km melalui jalan Kabupaten beraspal, sedangkan jalan ke Ibu Kota Kecamatan Karangjaya 2 km melalui jalan Kabupaten. Kemudian jarak ke Dusun yang paling jauh 5 km melalui jalan Desa, sebagian beraspal. Desa Karanglayung merupakan daerah perbukitan dengan ketinggian 297 m dari permukaan air laut dan curah hujan rata-rata 200-300 mm per tahun, dengan batas-batas wilayah sebagai berikut:
          </p>
          <div>
        ...
        <div className="py-10 lg:py-20 px-6 lg:px-20 flex flex-col justify-center items-center">
          <h3 className="lg:text-4xl text-2xl font-bold text-blue-700 mb-1">Lokasi Desa Karanglayung</h3>
